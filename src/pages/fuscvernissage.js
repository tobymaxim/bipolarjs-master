  ...
  <Layout data={data}>
    ...
    <div className="main-container">
      <div className="left-container">
        <div className="blackbox"><h1 className="headline1">FUSC Vernissage</h1></div>
...
export default EventfuscPage


export const query = graphql`
  query {
    allWordpressPage(filter: {template: {eq: "tpl-events.php"}, title: {eq: "Fusc Vernissage"}}) {
      edges {
        node {
          featured_media {
            localFile {
