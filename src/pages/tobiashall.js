  ...
  <Layout data={data}>
    ...
    <div className="main-container">
      <div className="left-container">
        <div className="blackbox"><h1 className="headline1">Tobias Hall</h1></div>
...
export default TobiashallPage


export const query = graphql`
  query {
    allWordpressPage(filter: {template: {eq: "tpl-artists.php"}, title: {eq: "Tobias Hall"}}) {
      edges {
        node {
          featured_media {
            localFile {
    ...
    allTribeEvents(sort: {order: ASC, fields: start_date}, filter: {categories: {elemMatch: {name: {eq: "Tobias Hall"}}}}) {
        edges {
          node {
            title
            description
