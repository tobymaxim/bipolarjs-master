  ...
  <Layout data={data}>
    ...
    <div className="main-container">
      <div className="left-container">
        <div className="blackbox"><h1 className="headline1">Alien Ritual - The Heritage</h1></div>
...
export default AlienritualtheheritagePage


export const query = graphql`
  query {
    allWordpressPage(filter: {template: {eq: "tpl-events.php"}, title: {eq: "Alien Ritual The Heritage"}}) {
      edges {
        node {
          featured_media {
            localFile {
