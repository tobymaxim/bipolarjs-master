  ...
  <Layout data={data}>
    ...
    <div className="main-container">
      <div className="left-container">
        <div className="blackbox"><h1 className="headline1">Alien Ritual - The 2nd Rise</h1></div>
...
export default Alienritualthe2ndrisePage


export const query = graphql`
  query {
    allWordpressPage(filter: {template: {eq: "tpl-events.php"}, title: {eq: "Alien Ritual The 2nd Rise"}}) {
      edges {
        node {
          featured_media {
            localFile {
